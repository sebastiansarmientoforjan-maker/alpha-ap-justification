            ...
            {currentPhase === "reflection" && (
              ...
              >
                ...
                <div className="p-6 bg-pink-500/10 border border-pink-500/30 rounded-xl">
                  ...
                  <div className="space-y-3">
                    {[
                      "I stated a condition but didn't justify WHY it holds",
                      "I forgot to verify ALL conditions mathematically",
                      "I used general principles (e.g., 'polynomials are continuous')",
                      "I checked conditions rigorously before applying the theorem",
                      "I showed all calculations explicitly"
                    ].map((learning, index) => (

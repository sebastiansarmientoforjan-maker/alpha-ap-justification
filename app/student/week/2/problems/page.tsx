                    ...
                    <div className="flex-grow">
                      ...
                      {isExpanded && (
                        <motion.div
                          ...
                          className="mb-4"
                        >
                          <p className="text-primary-200 leading-relaxed p-4 bg-primary-900/30 rounded-xl border border-accent-500/20">
                      ...
                      <div className="flex items-center gap-3">
                        {!isLocked ? (
                          <>
                            <Link href={`/student/week/2/problem/${problem.id}/instructions`}>

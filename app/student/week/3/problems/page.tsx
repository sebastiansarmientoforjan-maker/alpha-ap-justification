...
import { ArrowLeft, Target, TrendingUp, CheckCircle, Lock, Zap } from "lucide-react";
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        {problem.concepts.map((concept, i) => (
                          <span
                            key={i}
                            className="px-3 py-1 rounded-lg text-xs font-semibold bg-secondary-500/20 text-secondary-300 border border-secondary-500/30"
                          >
                            {concept}
                          </span>
                        ))}
                      ...
                      <p className="text-primary-200 mb-4 leading-relaxed text-sm">

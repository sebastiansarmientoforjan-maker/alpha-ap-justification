...
**(d)** At $t = 4$ seconds, is the particle speeding up or slowing down? Justify your answer using both velocity and acceleration.`,
    ...
    correctCERCResponse: {
      claim: "(a) s(t) = (t⁴/4) - 2t³ + (9t²/2) + 2. (b) The particle is at rest at t = 0 and t = 3 seconds. (c) Total distance is approximately 20.25 meters. (d) At t = 4, the particle is slowing down because velocity and acceleration have opposite signs.",
...
**(d)** If the farmer decides to build a fence parallel to the river in the middle of the field (creating two separate enclosures), how do the optimal dimensions change? Justify your answer.`,
    ...
    correctCERCResponse: {
      claim: "(a) A(x) = x(200-2x) = 200x - 2x². (b) The maximum area is 5000 m² with dimensions 50m × 100m. (c) EVT guarantees a maximum exists because A is continuous on [0,100] (closed and bounded). (d) With the middle fence, optimal dimensions become 50m × 66.67m.",
